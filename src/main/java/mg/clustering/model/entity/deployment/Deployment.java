...
@Table(name = "deployment",
       uniqueConstraints =
       {
         @UniqueConstraint(columnNames = {"deployment_id", "server_id",
...
public class Deployment {
  ...
  @Column(name = "build_file") private String buildFile;

  @Column(name = "artifact_file") private String artifactFile;

  @ManyToOne @JoinColumn(name = "config_file_id") private ConfigFile configFile;
  ...
  @Column(name = "deployment_message") private String deploymentMessage;
