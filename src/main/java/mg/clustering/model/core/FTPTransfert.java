...
public class FTPTransfert extends Transfert {
    public FTPTransfert(String ipv4, String username, String password, String port) {
    ...
    FTPClient getClient() {
        ...
        try {
            ...
            throw new RuntimeException("Error while connecting to FTP server " + getUsername() + "@" + getHost() + ":" + getPort());
        }
        return ftpClient;
    }
    ...
    public void upload(String sourcePath, String destinationPath) {
        try (FileInputStream localFile = new FileInputStream(sourcePath)) {
            ...
            throw new RuntimeException("Error while uploading file " + sourcePath + " to " + getHost() + ":" + getPort());
        }
    }
